...
# Import neural net
from neural-net import Generator, Discriminator
...
final_model_filename = "dcgan-gen-model.pth"
    ...
    for epoch in range(0, args.epochs):
        ...
        for i, (real_faces,_) in enumerate(train_loader):
            ...
            ****Generator training update****
            ...
            Disc_loss_list.append(D_losses.avg)
            Gen_loss_list.append(G_losses.avg)
            Disc_losses.reset()
            Gen_losses.reset()
